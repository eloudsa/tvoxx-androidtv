package net.noratek.tvoxx.androidtv.ui.controller;
...
public class PlaybackController {
    ...
    private static final String MEDIA_SESSION_TAG = "TVoxxAndroidTVSession";
    ...
    private static ArrayList<TalkFullModel> mItems;
    ...
    public PlaybackController(Activity activity, int currentItemIndex, ArrayList<TalkFullModel> items) {
        mActivity = activity;
        // mVideoView = (VideoView) activity.findViewById(VIDEO_VIEW_RESOURCE_ID);
    ...
    public void setPlaylist(int currentItemIndex, ArrayList<TalkFullModel> items) {
    ...
    public void setMovie (TalkFullModel talkFullModel) {
        // Log.v(TAG, "setMovie: " + movie.toString());
        mVideoView.setVideoPath(Constants.YOUTUBE_URL_PREFIX + talkFullModel.getYoutubeVideoId());
    }
    ...
    public void updateMetadata() {
        ...
        TalkFullModel talkFullModel = mItems.get(getCurrentItem());
        mDuration = Utils.getDuration(Constants.YOUTUBE_URL_PREFIX + talkFullModel.getYoutubeVideoId());
        updateMetadata(talkFullModel);
    }

    public void updateMetadata(TalkFullModel talkFullModel) {
        final MediaMetadata.Builder metadataBuilder = new MediaMetadata.Builder();

        String title = talkFullModel.getTitle().replace("_", " -");

        metadataBuilder.putString(MediaMetadata.METADATA_KEY_MEDIA_ID, talkFullModel.getTalkId());
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_DISPLAY_TITLE, title);
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_DISPLAY_SUBTITLE, talkFullModel.getConferenceLabel());
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_DISPLAY_DESCRIPTION, talkFullModel.getSummary());
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_DISPLAY_ICON_URI, talkFullModel.getThumbnailUrl());
        metadataBuilder.putLong(MediaMetadata.METADATA_KEY_DURATION, mDuration);

        // And at minimum the title and artist for legacy support
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_TITLE, title);
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_ARTIST, talkFullModel.getTalkType());

        Glide.with(mActivity)
                .load(Uri.parse(Constants.YOUTUBE_URL_PREFIX + talkFullModel.getYoutubeVideoId()))
                .asBitmap()
    ...
    private class MediaSessionCallback extends MediaSession.Callback {
        ...
        public void onSkipToNext() {
            ...
            TalkFullModel talkFullModel = mItems.get(mCurrentItem);
            //Movie movie = VideoProvider.getMovieById(mediaId);
            if (talkFullModel != null) {
                setVideoPath(Constants.YOUTUBE_URL_PREFIX + talkFullModel.getYoutubeVideoId());
                //mCurrentPlaybackState = PlaybackState.STATE_PAUSED;
        ...
        public void onSkipToPrevious() {
            ...
            TalkFullModel talkFullModel = mItems.get(mCurrentItem);
            //Movie talkFullModel = VideoProvider.getMovieById(mediaId);
            if (talkFullModel != null) {
                setVideoPath(Constants.YOUTUBE_URL_PREFIX + talkFullModel.getYoutubeVideoId());
                //mCurrentPlaybackState = PlaybackState.STATE_PAUSED;
                updateMetadata();

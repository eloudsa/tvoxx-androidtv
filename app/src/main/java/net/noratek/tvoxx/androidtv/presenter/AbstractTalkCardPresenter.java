 ...
 */
public abstract class AbstractTalkCardPresenter<T extends BaseCardView> extends Presenter {

    private static final String TAG = AbstractTalkCardPresenter.class.getSimpleName();
    private final Context mContext;

    /**
     * @param context The current context.
     */
    public AbstractTalkCardPresenter(Context context) {
        mContext = context;
    }
    ...
    public final void onBindViewHolder(ViewHolder viewHolder, Object item) {
        Talk talk = (Talk) item;
        onBindViewHolder(talk, (T) viewHolder.view);
    }
     ...
     *
     * @param talk The model containing the data for the card.
     * @param cardView The view the card is bound to.
     * @see Presenter#onBindViewHolder(Presenter.ViewHolder, Object)
     */
    public abstract void onBindViewHolder(Talk talk, T cardView);
